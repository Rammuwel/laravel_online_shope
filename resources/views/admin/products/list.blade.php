                ...
                <form action="{{route('products.index')}}" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button class="btn btn-default tbn-sm" type="button" onclick="window.location.href='{{route('products.index')}}'">Reset</button>
                        </div>
                       <div class="card-tools">
                          <div class="input-group input-group" style="width: 250px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                ...
                                                <img src="{{asset('default-150x150.png')}}" class="img-thumbnail" width="50" >
                                            @endif
