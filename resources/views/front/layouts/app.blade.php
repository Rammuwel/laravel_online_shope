        ...
        <div class="container">
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                ...
                <div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                    @if (Auth::check())
                    <a  class="nav-link p-0 pr-3"  href="{{route('account.profile')}}">
                        <img src="{{ asset('admin-assets/img/avatar5.png')}}" alt="My Profile" class="avatar">
                    </a>
                    @else
                    ...
                    <div class="footer-card">
                        ...
                        <ul>
                            ...
                            @if($pages->isNotEmpty())
                              ...
                              <li><a href="{{route('pages.page', $page->slug)}}" title="Privacy">{{$page->name}}</a></li> 
                              @endforeach
                            @endif
                        </ul>
                    </div>
