                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        ...
                        <div class="left">
                            ...
                            @else
                               <img src="{{ asset('upload/category/thumb/default.png') }}" alt="" class="img-fluid">
                        ...
                        <div class="right">
                            <div class="cat-data">
                                <a href="{{route('front.shop',$category->slug)}}"  class="text-dark">
                                <h2>{{$category->name}}</h2>
                                {{-- <p>100 Products</p> --}}
                                </a>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row pb-3">
            @if ($latestProducts->isNotEmpty())
                ...
                @php
                  $latestProductImage = $latestProduct->product_images->first();
                @endphp
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{ route('front.product', $latestProduct->slug )}}" class="product-img">
                                @if (!empty($latestProductImage))
                                <img class="card-img-top" src="{{asset('upload/product/small/'.$latestProductImage->image)}}" alt="">
                                @else
                                <img class="card-img-top" src="{{ asset('front-assets/images/product-1.jpg') }}" alt="">
                                @endif
                                
                            </a>
                            <a class="whishlist" onclick="addToWishList({{$latestProduct->id}})" href="javascript:void(0);"><i class="far fa-heart"></i></a>
                        ...
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="{{ route('front.product', $product->slug) }}">{{$latestProduct->title}}</a>
                            <div class="price mt-2">
