            ...
            <div class="card">
                <div class="card-body">								
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @if (!empty($category->image))
                                    <div class="card  flex align-content-center p-2">
                                        <img src=" {{ asset('upload/category/thumb/'.$category->image)}} " alt="" width="150px">
                                    </div>
                                   {{ asset('upload/category/thumb/'.$category->image)}}
                                @endif
                            </div>
                        </div>	
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="showHome">Show at Home</label>
...
<script type="text/javascript">
    $("#categoryForm").submit(function(event) {
        ...
        $.ajax({
            url: '{{ route("categories.update", $category->id) }}', // corrected 'ulr' to 'url'
            type: 'put',
