                                   ...
                                   @foreach ($productImages as $productImage)
                                    <div class='col-md-3' id="image-row-{{$productImage->id}}">
                                        <div class="card">
                                            ...
                                            <img src="{{asset('upload/product/small/'.$productImage->image)}}" class="card-img-top" alt="...">
                                            <div class="card-body">

                                                <button type="button" onclick="deleteImage({{$productImage->id}})" class="btn btn-sm btn-danger delete-image">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                   @endforeach
...
@section('customjs')
    <script type="text/javascript">
       ...
       $('.related_product').select2({
         ...
         // Manually trigger change event to refresh select2
        //  $('#related_product').val({{ json_encode($relatedProducts->pluck('id')) }}).trigger('change');
        ...
        success: function(file, response) {
            ...
            <div class='col-md-3' id="image-row-${response.image_id}">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button onclick="deleteImage(${response.image_id})" class="btn btn-sm btn-danger delete-image">Delete</button>
                    </div>
                </div>
            </div>`;
    ...
    function deleteImage(id){
       ...
       if (confirm('sure you want to delete image')) {
        $('#image-row-'+id).remove();
