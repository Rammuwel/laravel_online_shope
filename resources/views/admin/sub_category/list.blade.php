                ...
                <form action="{{route('sub-categories.index')}}" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button class="btn btn-default tbn-sm" type="button" onclick="window.location.href='{{route('sub-categories.index')}}'">Reset</button>
                        </div>
...
@section('customjs')
    ...
    <script>
        ...
        //    alert(newUrl);
           ...
           if (confirm('Are you sure you want to delete Sub category '+id+' ?')) {
                    $.ajax({
                    url: newUrl, 
                    type: 'delete',
                    data: {}, 
                    ...
                    success: function(response) {
                        ...
                        if (response['status'] == true) {
                            ...
                            //     window.location.href="{{route('sub-categories.index')}}";
                            // }
                            window.location.href="{{route('sub-categories.index')}}";  // not need to if else here
